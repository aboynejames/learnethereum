...
var balance = web3.eth.getBalance("099e0d0839150d859dc6ddcd45d8038c1757bb9c");
...
//console.log(blockwatch);
  ...
  web3.eth.contract(abi).new({data: code, gas: 3140000,}, function (err, contract) {
...
console.error(err);
    ...
    //  myContract.setSensorFirmware('2324fefre34343');
    //  myContract.setSensorMeasure('Accellerometer', 'Temperature', 'celcius');
